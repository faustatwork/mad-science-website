...
const Newsletter = () => {
  ...
  return (
    <>
      <div className="flex w-full flex-col items-center justify-center gap-5 rounded-2xl bg-blue-600 px-8 py-14 text-center sm:items-start sm:justify-start sm:text-start">
