...
const LevelThree: NextPage = () => {
  return (
    <>
      <Head>
        <title>Mad Science - Level 3</title>
        <meta property="title" content="Mad Science - Level 3" key="title" />
        <meta property="og:title" content="Mad Science - Level 3" key="title" />
        <meta name="description" content="Mad Science Level 3 kurs" />
        <meta name="og:description" content="Mad Science Level 3 kurs" />
        <meta
          property="og:url"
          content="https://mad-science-website.vercel.app/courses/level-three"
        />
        <link
          rel="canonical"
          href="https://mad-science-website.vercel.app/courses/level-three"
        />
      </Head>
      <Navbar />
