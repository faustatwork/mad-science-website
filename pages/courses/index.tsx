...
const Courses: NextPage = () => {
  return (
    <>
      <Head>
        <title>Mad Science - Kursevi</title>
        <meta property="title" content="Mad Science - Kursevi" key="title" />
        <meta property="og:title" content="Mad Science - Kursevi" key="title" />
        <meta name="description" content="Mad Science kursevi" />
        <meta name="og:description" content="Mad Science kursevi" />
        <meta
          property="og:url"
          content="https://mad-science-website.vercel.app/courses"
        />
        <link
          rel="canonical"
          href="https://mad-science-website.vercel.app/courses"
        />
      </Head>
      <Navbar />
