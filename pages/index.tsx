...
const Index: NextPage = () => {
  return (
    <>
      ...
      <div
        id="hero"
        className="mb-4 flex min-h-screen w-full flex-row items-center justify-center gap-80 bg-light bg-cover bg-center bg-no-repeat px-24 dark:bg-dark 2xl:justify-between lg:mb-20 lg:flex-col lg:justify-center lg:gap-10 lg:pt-40 lg:text-center sm:px-10"
      >
